    ...
    <>
      <div
        ...
        <nav className="lg:w-[94%] max-xl mx-auto bg-transparent py-4 lg:py-5 flex justify-between items-center relative">
          ...
          <div
            className={`hidden lg:flex items-center relative p-1.5 lg:p-2 rounded-xl bg-[#121926] font-semibold`}>
            <div
            ...
            {navItems.map((item, index) => {
              ...
              return item.isSection && pathname === "/" ? (
                <a
                  ...
                  className={`relative z-10 transition-all duration-200 px-3 lg:px-4 py-2 lg:py-2.5 text-xs lg:text-sm flex items-center gap-2 ${
                    isActive
                      ? "text-white font-bold"
                      : "text-[#9AA4B2] font-normal hover:text-white/90"
                  }`}>
                  {isActive && <Icon />}
                  {item.pathName}
                </a>
          ...
          <div className="hidden lg:flex items-center gap-3 lg:gap-4">
            <Link
              href="/sign-in"
              className={`font-bold cursor-pointer hover:scale-x-105 text-sm lg:text-base transition-colors ${
                isDarkBackground ? "text-white" : "text-[#121926]"
              }`}>
              Login
            </Link>
          ...
          <button
            ...
            <MenuIcon
              className={`font-medium w-6 h-6 cursor-pointer hover:scale-x-105 text-sm lg:text-base transition-colors ${
                isDarkBackground ? "text-white" : "text-[#121926]"
              }`}
            />
          </button>
