...
import { ArrowRight, Truck, CalendarDays} from "lucide-react"; 
import { CardBox } from '../shared/card-box' 
import { CartBasket, CoinStackIcon
} from '@/components/svg';
        ...
        <div className="grid items-center gap-10 md:grid-cols-2 md:gap-14">
          ...
          <div className="space-y-6 md:space-y-7">
            ...
            <h1 className="text-2xl font-black tracking-tight text-white md:text-[34px]">
              Managing Fashion Business <br />
              Operations 
            </h1>

            {/* body */}
            <p className="max-w-xl text-lg leading-relaxed text-[#9AA4B2] md:text-xl">
             Streamline your daily operations with tools designed specifically for fashion businesses. From design catalogs to vendor management.
            </p>
