        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="md:max-w-xl rounded-4xl bg-white p-0 gap-0 max-h-[90vh] overflow-y-auto font-sans">
                ...
                <div className="px-8 pb-6 space-y-5">
                        ...
                        <div className="border border-[#E3E3E3] rounded-lg overflow-hidden">
                            ...
                            <div className="bg-white p-3 flex items-center gap-2">
                                <button
                                    ...
                                    className={`p-2 hover:bg-gray-100 rounded transition-colors ${editor.isActive('bold') ? 'bg-gray-200' : ''
                                        }`}
                                >
                                ...
                                <button
                                    ...
                                    className={`p-2 hover:bg-gray-100 rounded transition-colors ${editor.isActive('italic') ? 'bg-gray-200' : ''
                                        }`}
                                >
                                ...
                                <button
                                    type="button"
                                    onClick={setLink}
                                    className={`p-2 hover:bg-gray-100 rounded transition-colors ${editor.isActive('link') ? 'bg-gray-200' : ''
                                        }`}
                                >
                                    <LinkIcon className="w-4 h-4 text-[#1D1D1D]" strokeWidth={3} />
                                </button>
                                <button
                                    type="button"
                                    onClick={() => editor.chain().focus().toggleBulletList().run()}
                                    className={`p-2 hover:bg-gray-100 rounded transition-colors ${editor.isActive('bulletList') ? 'bg-gray-200' : ''
                                        }`}
                                >
                                ...
                                <button
                                    ...
                                    className={`p-2 hover:bg-gray-100 rounded transition-colors ${editor.isActive('orderedList') ? 'bg-gray-200' : ''
                                        }`}
                                >
                                    <ListOrdered className="w-4 h-4 text-[#1D1D1D]" strokeWidth={3} />
                                </button>
                            </div>
                            ...
                            >
                                <div className="p-3 border-b">
                                    <div className="relative">
                                        <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-6 h-6 text-[#9AA4B2]" strokeWidth={1}/>
                                        <Input
                    ...
                    {/* Submit Button */}
                    <Button
                        disabled={!title || !description || !note || selectedStaff.length === 0}
