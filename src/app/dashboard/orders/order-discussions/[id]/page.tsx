...
import { Edit, Share, Trash } from '@/src/components/_core/dashboard/design-operations/svg';
...
export default function DiscussionPage() {
    ...
    const comments: Comment[] = [
        {
            ...
            content: 'Love the lace overlay idea! Can we also consider adding some pearl detailing?',
            ...
            <div className="">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center">
                        <Button variant="ghost" size="icon" className="text-[#9AA4B2] hover:bg-white rounded-full cursor-pointer">
                            <Edit />
                        </Button>
                        <Button variant="ghost" size="icon" className="text-[#9AA4B2] hover:bg-white rounded-full cursor-pointer">
                            <Share />
            ...
            <div className="bg-white my-8 p-6 rounded-3xl">
                ...
                <div className="mb-6">
                    <div className="flex flex-col items-start gap-3 mb-3">
                        <FileText className="text-[#F74F25] mt-1" size={30} strokeWidth={1} />
            ...
            <div className="rounded-lg">
                <div className="border-gray-200">
                    <div className="flex items-center gap-2">
                        ...
                        <h2 className="font-semibold text-gray-900">Comments ({comments.length})</h2>
                    </div>
                </div>
                ...
                {yesterdayComments.length > 0 && (
                    <div>
                        <div className=" py-3 flex justify-between items-center gap-2">
                            ...
                            <span className="text-xs font-medium text-[#9AA4B2]">Yesterday</span>
                            <div className='border-b w-full border-[#9AA4B2]'></div>
                        </div>
    ...
    "
                                ...
                                <span className="text-xs text-gray-400 ml-12">{comment.timestamp}</span>
                            </div>
                        ))}
                    </div>
                )}
